...
#include "../eternity_common/DOA6/small_dictionary.h"
...
bool KtidFile::SaveToString(std::string &output, const std::string &path, bool *crack_success, bool full_crack)
{
    std::stringstream ss;
    bool is_me = false;
